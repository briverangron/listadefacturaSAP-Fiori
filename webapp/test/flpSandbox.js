		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Listado de Factura",
									"targetURL": "#facturaloposfactura-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"facturaloposfactura-display": {
								"semanticObject": "facturaloposfactura",
								"action": "display",
								"description": "una lista de las facturas",
								"title": "Listado de Factura",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=facturalopos.factura",
									"url": sap.ui.require.toUrl("facturalopos/factura")
								}
							}
						}
					}
